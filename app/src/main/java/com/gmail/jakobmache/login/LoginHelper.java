...
public class LoginHelper {
    ...
    public String fetchPlan() throws IOException {
        return NetworkUtils.getWebPageAsString(PLAN_URL, cookie);
    }
    ...
    private void postForm(String username, String password) throws IOException
    {
